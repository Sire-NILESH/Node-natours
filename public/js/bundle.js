...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Add popup message on each marker

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description)).addTo(map); // Extend map bounds to include current locations.
...
},{"./utils":"../../node_modules/axios/lib/utils.js","./helpers/normalizeHeaderName":"../../node_modules/axios/lib/helpers/normalizeHeaderName.js","./adapters/xhr":"../../node_modules/axios/lib/adapters/xhr.js","./adapters/http":"../../node_modules/axios/lib/adapters/xhr.js","process":"C:/Users/Devesh/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../../node_modules/axios/lib/core/dispatchRequest.js":[function(require,module,exports) {
'use strict';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            //err will be thrown by axios from api. 
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              window.setTimeout(function () {
                location.reload(true); //location.assign('/');         //location is where to goto, root page here.
              }, 1500); //location.reload(true);  //'true' will make the reload from the server side. default is from the browser's cache.
            }
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, password, passwordConfirm) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log("signup ".concat(email, " ").concat(password, " ").concat(passwordConfirm));
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'POST',
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Signup successfull, Welcome');
              window.setTimeout(function () {
                location.assign('/'); //location is where to goto, root page here.
              }, 1500);
            }
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51JWJ70SHkzkRG21mPCIgtqOGMcws87vJ5ZX2tx4BV5wDaOzyDVwXwhQ2FCb6LMXTUInLeYLg8tDSBIbXjrBK7wqN00xMWPeeOz'); // 1) Get the checkout session from the API
          ...
          case 4:
            ...
            // this is how to req for simple 'get'.
...
var logOutBtn = document.querySelector('.nav__el--logout'); //inside the header.pug

var userDataForm = document.querySelector('.form-user-data'); //inside account.pug

var userPasswordForm = document.querySelector('.form-user-password'); //inside account.pug

var bookBtn = document.getElementById('book-tour'); //inside tour.pug
// const bookBtn = document.querySelector('#book-tour'); //inside tour.pug

if (mapbox) {
  //get data from UI for mapbox
  var locations = JSON.parse(document.getElementById('map').dataset.locations); //call mapbox
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); //for multpart/formdata like photos

    var form = new FormData();
    form.append('name', document.getElementById('name').value);
    form.append('email', document.getElementById('email').value);
    form.append('photo', document.getElementById('photo').files[0]);
    (0, _updateSettings.updateSettings)(form, 'data'); // //for simple use case
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault(); //let the user know its loading

              document.querySelector('.btn--save-password').textContent = 'Updating...';
              passwordCurrent = document.getElementById('password-current').value;
              password = document.getElementById('password').value;
              passwordConfirm = document.getElementById('password-confirm').value; //await this func to perform below actions after function is processed.
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "17944" + '/');
...
},{}]},{},["C:/Users/Devesh/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
